...
import { useGetAllComplaints } from '../../hooks/complaints/useGetAllComplaints';
...
const RenderComplaints = () => {
  ...
  const { data, isFetching, isError } = useGetAllComplaints({ page, limit: rowsPerPage });
        ...
        {isError ? <MessageBox message="Something went wrong" />
          : isFetching ? <Spinner /> :
            ...
            complaints={data?.data}
              ...
              totalNoOfDocs={data?.pagination?.totalPages}
